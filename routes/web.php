...
Route::get('/pendaftaran/diterima', [PendaftaranController::class, 'terima'])->name('detail-terima')->middleware('role_or_permission:admin|manage_pendaftar');

Route::get('/pendaftaran/detail/{id}', [PendaftaranController::class, 'detail'])->name('detail-pendaftaran')->middleware('role_or_permission:admin|manage_pendaftar');;
